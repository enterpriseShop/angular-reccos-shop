...
export class PlaceholderPageComponent {
  ...
  readonly mockData: PlaceholderRowItem[] = [
    { code: 'ITEM-001', name: 'Sistemas de Freios ABS / Disc / Pad', category: 'Sistemas Ativos', updatedAt: '27/07/2026 10:14', status: 'Ativo' },
    { code: 'ITEM-002', name: 'Kits de Distribuição e Correias Sincronizadoras', category: 'Transmissão', updatedAt: '27/07/2026 09:30', status: 'Ativo' },
    { code: 'ITEM-003', name: 'Conjunto de Amortecedores e Molas Helicoidais', category: 'Suspensão', updatedAt: '26/07/2026 18:22', status: 'Ativo' },
    { code: 'ITEM-004', name: 'Sistema de Ignição e Injeção Eletrônica Flex', category: 'Elétrica', updatedAt: '25/07/2026 14:10', status: 'Ativo' },
    { code: 'ITEM-005', name: 'Filtros de Lubrificantes, Ar e Combustível', category: 'Manutenção', updatedAt: '24/07/2026 11:05', status: 'Ativo' },
    { code: 'ITEM-006', name: 'Sensores de Rotação, Oxigênio e Pressão MAP', category: 'Injeção', updatedAt: '24/07/2026 08:12', status: 'Ativo' },
    { code: 'ITEM-007', name: 'Kits de Embreagem Cobre / Aço Orgânica', category: 'Transmissão', updatedAt: '23/07/2026 16:45', status: 'Ativo' },
    { code: 'ITEM-008', name: 'Bombas d\'Água e Termostatos de Arrefecimento', category: 'Motor', updatedAt: '23/07/2026 12:20', status: 'Ativo' },
    { code: 'ITEM-009', name: 'Radiadores e Ventoinhas do Ar-Condicionado', category: 'Climatização', updatedAt: '22/07/2026 17:00', status: 'Inativo' },
    { code: 'ITEM-010', name: 'Terminais de Direção e Pivôs de Suspensão', category: 'Direção', updatedAt: '22/07/2026 10:15', status: 'Ativo' },
    { code: 'ITEM-011', name: 'Bujões e Juntas de Vedação de Aço Inox', category: 'Motor', updatedAt: '21/07/2026 15:30', status: 'Ativo' },
    { code: 'ITEM-012', name: 'Faróis Principais e DRL em LED Alta Intensidade', category: 'Iluminação', updatedAt: '21/07/2026 09:10', status: 'Ativo' }
  ];
